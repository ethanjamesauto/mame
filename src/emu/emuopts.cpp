...
const options_entry emu_options::s_option_entries[] =
{
	...
	{ OPTION_VECTOR_SERIAL,                              "",          core_options::option_type::STRING,     "set vector serial device" },
	{ OPTION_VECTOR_SCALE,                               "0.0",       core_options::option_type::FLOAT,      "set vector serial output scale" },
	{ OPTION_VECTOR_SCALE_X,                             "1.0",       core_options::option_type::FLOAT,      "set vector x axis serial output scale" },
	{ OPTION_VECTOR_SCALE_Y,                             "1.0",       core_options::option_type::FLOAT,      "set vector y axis serial output scale" },
	{ OPTION_VECTOR_OFFSET_X,                            "2048",      core_options::option_type::FLOAT,      "set vector x axis serial offset (1024)" },
	{ OPTION_VECTOR_OFFSET_Y,                            "2048",      core_options::option_type::FLOAT,      "set vector y axis serial offset (1024)" },
	{ OPTION_VECTOR_ROTATE,                              "0",         core_options::option_type::INTEGER,    "set vector serial rotation (0,1,2,3)" },
	{ OPTION_VECTOR_BRIGHT,                              "255",       core_options::option_type::INTEGER,    "set vector threshold for bright lines (0-255)" },
